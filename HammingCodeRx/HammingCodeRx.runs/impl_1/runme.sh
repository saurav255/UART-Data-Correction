...
HD_PWD='C:/Vivado_Projects/HammingCodeRx/HammingCodeRx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HammingCodeRx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HammingCodeRx.tcl -notrace
