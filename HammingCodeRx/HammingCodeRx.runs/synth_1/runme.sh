...
HD_PWD='C:/Vivado_Projects/HammingCodeRx/HammingCodeRx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HammingCodeRx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HammingCodeRx.tcl
