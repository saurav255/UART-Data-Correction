...
HD_PWD='C:/Vivado_Projects/HammingCodeTx/HammingCodeTx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HammingCodeTx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HammingCodeTx.tcl -notrace
