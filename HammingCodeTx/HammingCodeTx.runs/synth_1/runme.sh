...
HD_PWD='C:/Vivado_Projects/HammingCodeTx/HammingCodeTx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HammingCodeTx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HammingCodeTx.tcl
